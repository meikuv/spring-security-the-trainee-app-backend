package meikuv.springthetraineeappbackend.controllers;
...
import meikuv.springthetraineeappbackend.models.User;
...
import meikuv.springthetraineeappbackend.payload.response.UserInfoResponse;
import meikuv.springthetraineeappbackend.repository.RoleRepository;
import meikuv.springthetraineeappbackend.repository.UserRepository;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "mod":
                        Role modRole = roleRepository.findByRole(ERole.MODERATOR_ROLE)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(modRole);
